...
class Hyperparameters:
    ...
    def __init__(self):
        ...
        hp["buffer_sample_size"] = 64                           # replay buffer sample size (batch size)
        hp["buffer_sample_iterations"] = 2                      # replay buffer sample learning iterations

        # action noise parameters
        hp["noise_maximum"] = 10.00                             # maximum noise (starting noise)
        hp["noise_minimum"] = 0.01                              # minimum noise (ending noise)
        hp["noise_decay"] = 0.995                               # noise reduction factor per steps
