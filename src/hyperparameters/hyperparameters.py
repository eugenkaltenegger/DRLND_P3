...
class Hyperparameters:
    ...
    def __init__(self):
        ...
        hp["noise_decay"] = 1.0                                 # noise reduction factor per steps

        # network parameters
        hp["tau"] = 0.001                                       # tau (0 < tau < 1)

        # actor parameters
        hp["actor_layers"] = [400, 300]                         # actor layers
        ...
        # critic parameters
        hp["critic_layers"] = [400, 300]                        # critic layers
